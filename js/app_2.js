(function() {
  ...
  app.controller('treeGridController', function($scope, $timeout) {
    ...
    var rawTreeData = [
            ...
            {"DemographicId":3,"ParentId":5,"Name":"San Francisco","Description":"The happening city","Area":231,"Population":837442,"TimeZone":"PST"},
    ...
    $scope.col_defs = [
    	{ field: "Description"},
    	{ field: "Area"},
    	{ field: "Population", cellTemplate: '<a href="#" editable-text="user.name">{{row.branch[col.field]}}</a>'},
